...
Use Electron Builder in this package to generate installers/executables.
...
> Note: packaging profiles can be expanded per platform once the app UI modules are added.
